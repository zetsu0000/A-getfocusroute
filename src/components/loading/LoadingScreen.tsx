...
export function LoadingScreen() {
  ...
  return (
    <div style={{
      ...
      >
        <p style={{ fontSize: 24, fontWeight: 800, color: "var(--color-primary)", textAlign: "center" }}>
          FocusRoute
        </p>
        <p style={{ fontSize: 15, color: "var(--color-text-body)", marginTop: 4, marginBottom: 18, textAlign: "center" }}>
