...
/* V2 "Focus Observatory" display + telemetry faces (experimental visual branch). */
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`light ${jakarta.variable} ${fraunces.variable} ${plexMono.variable}`}>
